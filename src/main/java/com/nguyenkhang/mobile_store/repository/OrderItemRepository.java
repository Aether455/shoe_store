...
public interface OrderItemRepository extends JpaRepository<OrderItem, Long> {
    ...
    @Query("SELECT new com.nguyenkhang.mobile_store.dto.response.statistic.ProductRevenueResponse(" + "  p.id, "
            + " p.mainImageUrl,"
            + "  p.name, "
            + "  SUM(oi.totalPrice)) "
            + "FROM OrderItem oi "
    ...
    @Query("SELECT new com.nguyenkhang.mobile_store.dto.response.statistic.CategoryRevenueResponse(" + "  c.id, "
            + "  c.name, "
            + "  SUM(oi.totalPrice)) "
            + "FROM OrderItem oi "
            + "JOIN oi.product p "
    ...
    @Query("SELECT new com.nguyenkhang.mobile_store.dto.response.statistic.BrandRevenueResponse(" + "  b.id, "
            + "  b.name, "
            + "  SUM(oi.totalPrice)) "
            + "FROM OrderItem oi "
            + "JOIN oi.product p "
    ...
    @Query("SELECT new com.nguyenkhang.mobile_store.dto.response.statistic.SellingProductResponse(" + "  p.id, "
            + " p.mainImageUrl,"
            + "  p.name, "
            + "  SUM(oi.quantity)) "
            + "FROM OrderItem oi "
