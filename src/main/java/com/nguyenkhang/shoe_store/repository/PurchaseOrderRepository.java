...
public interface PurchaseOrderRepository
    ...
    @Query("SELECT new com.nguyenkhang.shoe_store.dto.response.purchase_order.PurchaseOrderReportResponse("
            + "po.supplier.name, "
            + "SUM(po.totalAmount),"
            + "COUNT(po)) "
    ...
    List<PurchaseOrderReportResponse> reportBySupplier(
            @Param("start") LocalDateTime start, @Param("end") LocalDateTime end);

    @Query(
            """
				SELECT new com.nguyenkhang.shoe_store.dto.response.purchase_order.PurchaseOrderReportResponse(
    ...
    List<PurchaseOrderReportResponse> reportByMonth(
            @Param("start") LocalDateTime start, @Param("end") LocalDateTime end);
